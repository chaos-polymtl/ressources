...
\begin{align}
	\pp{q,\partial_t \varepsilon}_\Omega + \pp{q, \varepsilon \partial_i u_i}_\Omega + \pp{q, u_i \partial_i \varepsilon}_\Omega + \underbrace{\pp{\tau_{\vm{u}} \partial_i q, \mathcal{R}_{i}^{\mathrm{VANS}}}_{\Omega_e}}_{\mathrm{PSPG}} = 0
\end{align}
...
\begin{align}
	\vm{\mathcal{R}}^{\mathrm{VANS}} &= \varepsilon_{\mathrm{f}}\partial_t \vm{u} + \varepsilon_{\mathrm{f}}\vm{u} \nabla \cdot \vm{u} 
	+ \frac{1}{\rho} \bra{\varepsilon_{\mathrm{f}}\nabla p - \nu \pp{\varepsilon_{\mathrm{f}}\nabla^2 \vm{u} + \nabla \vm{u} \cdot \nabla \varepsilon_{\mathrm{f}}} }
\end{align}
\end{frame}
